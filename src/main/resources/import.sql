...
INSERT INTO tb_game (title, score, game_year, genre, platforms, img_url, short_description, long_description) VALUES ('Sekiro: Shadows Die Twice', 4.7, 2019, 'Action, Adventure', 'Xbox, Playstation, PC', 'https://example.com/sekiro.jpg', 'A challenging samurai action game.', 'Master the art of stealth and combat in feudal Japan.');
INSERT INTO tb_game (title, score, game_year, genre, platforms, img_url, short_description, long_description) VALUES ('Ghost of Tsushima', 4.8, 2020, 'Action, Adventure', 'Playstation', 'https://example.com/ghostoftsushima.jpg', 'A beautiful open-world samurai game.', 'Defend Tsushima Island during the Mongol invasion.');
INSERT INTO tb_game (title, score, game_year, genre, platforms, img_url, short_description, long_description) VALUES ('Super Mario World', 4.9, 1990, 'Platformer', 'SNES', 'https://example.com/supermarioworld.jpg', 'A classic platformer game.', 'Join Mario on an adventure through Dinosaur Land.');
